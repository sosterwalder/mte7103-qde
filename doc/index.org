...
#+HEADER:     :prologue <<gui-scene-system-imports>>
#+BEGIN_SRC python :exports none
...
#+HEADER:     :prologue <<gui-scene-project-imports>>
#+BEGIN_SRC python :exports none
...
#+HEADER:     :prologue <<gui-scene-graph-signals>>
#+BEGIN_SRC python :exports none
...
#+HEADER:     :prologue <<gui-scene-graph-methods>>
#+BEGIN_SRC python :exports none
...
#+HEADER:     :prologue <<gui-scene-graph-slots>>
#+BEGIN_SRC python :exports none
...
graph view is shown in listing TODO.
...
:GUI_SCENE_GRAPH_SIGNALS_02:
#+NAME:      gui-scene-graph-signals-02
#+BEGIN_SRC python :exports none
...
#+HEADER:     :prologue <<gui-scene-graph-signals>>
#+BEGIN_SRC python :exports none
<<gui-scene-graph-signals-02>>
#+END_SRC

#+NAME:       lst:gui-scene-graph-signals-01
#+ATTR_LaTeX: :options fontsize=\footnotesize,linenos,bgcolor=bashcodebg
#+CAPTION:    Definition of the signals in case a tree item is added or removed.
#+BEGIN_SRC python :noweb yes
<gui-scene-graph-signals>+=
    <<gui-scene-graph-signals-02>>
#+END_SRC
...
:GUI_SCENE_GRAPH_CONSTRUCTOR_01:
...
#+HEADER:     :prologue <<gui-scene-graph-constructor>>
#+BEGIN_SRC python :exports none
...
#+ATTR_LaTeX: :options fontsize=\footnotesize,linenos,bgcolor=bashcodebg
#+CAPTION:    Definition of the slots which gets called in case tree items are added or removed respectively.
#+BEGIN_SRC python :noweb yes
<gui-scene-graph-slots>+=
    <<gui-scene-graph-slots-02>>
#+END_SRC
