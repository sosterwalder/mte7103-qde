...
<2017-02-20 Mon> Initial set up and structuring of the document.
...
#+BEGIN_SRC python :tangle ../src/qde/editor/application/test_application.py :noweb tangle :comments link :mkdirp yes
<<test-app-header>>
...
#+BEGIN_SRC python :tangle ../src/qde/editor/foundation/test_common.py :noweb tangle :comments link :mkdirp yes
  # -*- coding: utf-8 -*-
