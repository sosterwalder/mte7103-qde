...
\end{tabular}
\end{center}\footnotetext[1]{\label{org5fb617b}sven.osterwalder@students.bfh.ch}\footnotetext[2]{\label{org6012d0f}claude.fuhrer@bfh.ch}\footnotetext[3]{\label{orgfc40481}eric.dubuis@comet.ch}

\section{Structure of the documentation}
\label{sec:org89c36d2}
...
\label{sec:orgc052259}
\subsection{Code}
\label{sec:org16e9c88}

\subsubsection{{\bfseries\sffamily TODO} Principles}
\label{sec:orgea2bb27}
...
\subsection{Diagrams}
\label{sec:org580983f}

[Diagrams.]

\subsection{Project structure}
\label{sec:org544c080}

[Project structure.]

\chapter{{\bfseries\sffamily TODO} Implementation}
\label{sec:org8258c90}

\section{Requirements}
\label{sec:org5de4381}
...
\end{minted}
\caption{Scene module inside the \texttt{gui\_domain} package, holding currently only the \texttt{SceneGraphViewModel} class.}
\end{listing}
...
def __init__(
    ...
    self.name = name
\end{minted}
\caption{\label{guidomain-scene-viewmodel-constructor}
...
\end{minted}
\caption{The outline of the \texttt{SceneGraphController} class, inside the \texttt{application} package.}
\end{listing}
...
\label{sec:orgb5adcaa}

\printbibliography{}

\chapter{Appendix}
\label{sec:org9d4657e}

\section{Test cases}
\label{sec:org7b29052}
...
\label{sec:org1461f3f}

\subsection{Meeting mintutes 2017-02-23}
\label{sec:org10bbd40}
