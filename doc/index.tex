...
\definecolor{bashcodebg}{rgb}{0.97255, 0.97255, 0.97255}
...
\end{tabular}
\end{center}\footnotetext[1]{\label{org1fb512e}sven.osterwalder@students.bfh.ch}\footnotetext[2]{\label{orgb4c1bc6}claude.fuhrer@bfh.ch}\footnotetext[3]{\label{org6ee0df5}eric.dubuis@comet.ch}

\section{Structure of the documentation}
\label{sec:org74d5fda}
...
\label{sec:orge767fb5}
\subsection{Code}
\label{sec:org993edea}
...
\begin{listing}[H]
\begin{minted}[,fontsize=\footnotesize,linenos,bgcolor=bashcodebg]{ebnf}
...
Connections & A list of connections of the node's inputs and outputs.\\
 ...
 & \\
\end{tabular}
\end{center}\footnotetext[32]{\label{org8e78a4f}\url{https://docs.python.org/3/library/uuid.html}}
