...
\end{tabular}
\end{center}\footnotetext[1]{\label{org2ccca9a}sven.osterwalder@students.bfh.ch}\footnotetext[2]{\label{org339fbfd}claude.fuhrer@bfh.ch}\footnotetext[3]{\label{org7fa24bb}eric.dubuis@comet.ch}

\section{Structure of the documentation}
\label{sec:org05883da}
...
\label{sec:org3b7492b}
\subsection{Code}
\label{sec:org2ea091d}

\subsubsection{{\bfseries\sffamily TODO} Principles}
\label{sec:org5dc9e76}
...
\subsection{Diagrams}
\label{sec:org777305c}

[Diagrams.]

\subsection{Project structure}
\label{sec:org4b5e8b1}

[Project structure.]

\chapter{{\bfseries\sffamily TODO} Implementation}
\label{sec:org5006749}

\section{Requirements}
\label{sec:org1891f78}
...
Expansion of the scene view model's methods by adding the \texttt{headerData} method which overwrites the method inherited by QAbstractItemModel.}
\end{listing}
...
\label{sec:org9793d39}

\printbibliography{}

\chapter{Appendix}
\label{sec:orgdfac0d7}

\section{Test cases}
\label{sec:orge063aa9}
...
\label{sec:org076e6d8}

\subsection{Meeting mintutes 2017-02-23}
\label{sec:org1fee8b4}
