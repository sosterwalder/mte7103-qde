...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb?}{?}\NWlink{nuweb?}{, ?}\NWlink{nuweb167b}{, 167b}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb?}{?}.
...
\NWtarget{nuweb103a}{} $\langle\,${\itshape Set logger name}\nobreak\ {\footnotesize {103a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{pythoncode}
...
\NWtarget{nuweb103b}{} $\langle\,${\itshape Logger interface}\nobreak\ {\footnotesize {103b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{pythoncode}
...
\NWtarget{nuweb159a}{} $\langle\,${\itshape On node definition added implementation}\nobreak\ {\footnotesize {159a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{pythoncode}
|\hbox{$\langle\,${\itshape Check if the node definition is already known}\nobreak\ {\footnotesize \NWlink{nuweb159b}{159b}}$\,\rangle$}|
...
\NWtarget{nuweb159b}{} $\langle\,${\itshape Check if the node definition is already known}\nobreak\ {\footnotesize {159b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{pythoncode}
...
\NWtarget{nuweb162}{} $\langle\,${\itshape Get or create column by type name}\nobreak\ {\footnotesize {162}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{pythoncode}
...
\NWtarget{nuweb164a}{} $\langle\,${\itshape Add node dialog methods}\nobreak\ {\footnotesize {164a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{pythoncode}
...
\NWtarget{nuweb164b}{} $\langle\,${\itshape Get existing column object by name}\nobreak\ {\footnotesize {164b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{pythoncode}
...
\NWtarget{nuweb165a}{} $\langle\,${\itshape Create new column object based on name}\nobreak\ {\footnotesize {165a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{pythoncode}
else:
...
\NWtarget{nuweb165b}{} $\langle\,${\itshape Create sub frame for given node definition}\nobreak\ {\footnotesize {165b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{pythoncode}
...
\NWtarget{nuweb166a}{} $\langle\,${\itshape Create button for given node definition and add to sub frame}\nobreak\ {\footnotesize {166a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{pythoncode}
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb166a}{166a}\NWlink{nuweb166b}{b}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb159a}{159a}.
...
\NWtarget{nuweb166b}{} $\langle\,${\itshape Create button for given node definition and add to sub frame}\nobreak\ {\footnotesize {166b}}$\,\rangle+\equiv$
\vspace{-1ex}
\begin{pythoncode}
...
\NWtarget{nuweb166c}{} $\langle\,${\itshape Add sub frame to column}\nobreak\ {\footnotesize {166c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{pythoncode}
...
\NWtarget{nuweb167a}{} $\langle\,${\itshape Save the node definition to list of known nodes}\nobreak\ {\footnotesize {167a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{pythoncode}
...
\NWtarget{nuweb167b}{} $\langle\,${\itshape Connect main window components}\nobreak\ {\footnotesize {167b}}$\,\rangle+\equiv$
\vspace{-1ex}
\begin{pythoncode}
