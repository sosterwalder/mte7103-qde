...
\end{tabular}
\end{center}\footnotetext[1]{\label{org0cb098e}sven.osterwalder@students.bfh.ch}\footnotetext[2]{\label{org8b7ee8b}claude.fuhrer@bfh.ch}\footnotetext[3]{\label{orgec6f1d0}eric.dubuis@comet.ch}

\section{Structure of the documentation}
\label{sec:org8984915}
...
\label{sec:org52d6f49}
\subsection{Code}
\label{sec:orgbea6dc2}

\subsubsection{{\bfseries\sffamily TODO} Principles}
\label{sec:org5215809}
...
\subsection{Diagrams}
\label{sec:orgff4e8e8}

[Diagrams.]

\subsection{Project structure}
\label{sec:org403f110}

[Project structure.]
\chapter{{\bfseries\sffamily TODO} Implementation}
\label{sec:orga80cd2c}
\section{Requirements}
\label{sec:org8e973ca}
\subsection{Requirements}
\label{sec:orgb9f22db}
...
\label{sec:orgb4950c2}
\end{enumerate}

\item Scheduling of the next meeting
\label{sec:orgf3014bd}
