...
\end{tabular}
\end{center}\footnotetext[1]{\label{orgfb069a2}sven.osterwalder@students.bfh.ch}\footnotetext[2]{\label{org4d7c76a}claude.fuhrer@bfh.ch}
