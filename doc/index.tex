...
\end{tabular}
\end{center}\footnotetext[1]{\label{org6dc9b64}sven.osterwalder@students.bfh.ch}\footnotetext[2]{\label{org784dcf8}claude.fuhrer@bfh.ch}\footnotetext[3]{\label{org782d32e}eric.dubuis@comet.ch}
...
\label{sec:org7b5da71}
\subsection{Code}
\label{sec:org9c0d754}

\subsubsection{{\bfseries\sffamily TODO} Principles}
\label{sec:org4850ba4}
...
with a root scene of type \myverb{Scene}.

The least tedious of those aspects may be the scene model, \myverb{Scene}, so
...
class Scene(object):
    ...
    <<domain-scene-slots>>
\end{minted}
\caption{Scene module inside the \texttt{domain} package, holding the \texttt{Scene} class.}
\end{listing}
...
Constructor of the scene model class, \texttt{Scene}.}
\end{listing}
