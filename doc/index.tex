...
\NWtarget{nuweb?}{} $\langle\,${\itshape Set logger name}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{pythoncode}
...
\NWtarget{nuweb?}{} $\langle\,${\itshape Logger interface}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{pythoncode}
...
\NWtarget{nuweb?}{} $\langle\,${\itshape On node definition added implementation}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{pythoncode}
...
\NWtarget{nuweb?}{} $\langle\,${\itshape Check if the node definition is already known}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{pythoncode}
...
\NWtarget{nuweb?}{} $\langle\,${\itshape Get or create column by type name}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{pythoncode}
...
\NWtarget{nuweb?}{} $\langle\,${\itshape Add node dialog methods}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{pythoncode}
...
\NWtarget{nuweb?}{} $\langle\,${\itshape Get existing column object by name}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{pythoncode}
...
\NWtarget{nuweb?}{} $\langle\,${\itshape Create new column object based on name}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{pythoncode}
else:
...
\NWtarget{nuweb?}{} $\langle\,${\itshape Create sub frame for given node definition}\nobreak\ {\footnotesize {?}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{pythoncode}
