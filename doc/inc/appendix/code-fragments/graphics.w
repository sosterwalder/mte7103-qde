...
class Graphics(object):
    ...
    @<Graphics activate render state@>
    @<Graphics activate render target@>
    @<Graphics activate all render targets@>
    @<Graphics add geometry@>
    @<Graphics add shader@>
    @<Graphics clear@>
    @<Graphics clear render state@>
    @<Graphics create buffer@>
    @<Graphics create FBO@>
    @<Graphics create IBO@>
    @<Graphics create VAO@>
    @<Graphics create VBO@>
    @<Graphics deactivate all render targets@>
    @<Graphics deactivate current render state@>
    @<Graphics deactivate render target@>
    @<Graphics load geometry@>
    @<Graphics get attribute location@>
    @<Graphics get uniform location@>
    @<Graphics load shader from template@>
    @<Graphics render geometry@>
    @<Graphics render implicit@>
    @<Graphics set clear color@>
    @<Graphics set up IBO@>
    @<Graphics set up VAO@>
    @<Graphics set up VBO@>
    @<Graphics set value for uniform@>
    @<Graphics convert vertices to array@>

    # Slots

    # Classmethods

    @<Graphics create instance@>
    @<Graphics get instance@>
@}


@d Render state class
@{
@@common.with_logger
...
@d Graphics activate render state
@{
...
@d Graphics activate render target
@{
...
@d Graphics activate all render targets
@{
...
@d Graphics deactivate current render state
@{
...
@d Graphics deactivate render target
@{
...
@d Graphics deactivate all render targets
@{
...
def load_geometry(self, geometry, vertices, indices=None, colors=None):
    ...
    if geometry.is_dynamic:
        @<Graphics load dynamic geometry@>
...
@d Graphics load dynamic geometry
@{
...
@d Graphics get attribute location
@{
...
@d Graphics get uniform location
@{
...
@d Graphics load shader from template
@{
...
def render_geometry(self, geometry):
    ...
    # TODO: Do this dynamically
    @<Graphics set global uniforms@>

    # TODO: Read from render_state / geometry
    if geometry.is_indexed:
        @<Graphics render indexed geometry@>

    else:
        @<Graphics render non-indexed geometry@>
...
@d Graphics set global uniforms
@{
...
@d Graphics render indexed geometry
@{
vao = geometry.vertex_array_object
vao.bind()
...
@d Graphics render non-indexed geometry
@{
...
@d Graphics set value for uniform
@{
...
@d Graphics convert vertices to array
@{
